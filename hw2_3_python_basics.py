# -*- coding: utf-8 -*-
"""HW2_3_python_basics.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1kb4pBRr9q-ngnD0jiSPT9Ix_52ysaH_u
...
def no_vowels(text):
    return "".join([char for char in text if char.lower() not in "aoeiu"])
...
import requests # Without this there's HTTP 403 Forbidden. I asked AI what to do
...
def extract_revenue(df, column, name):
    df[name] = df[column].apply(lambda x: round(price_dec(str(x)) / 1_000_000, 2))
    return df
